...
export default function NavBar() {
  return (
    <div className="px-16 md:px-0">
      <NavBarMobile />
      <div className=" md:hidden flex justify-between items-center px-5  bg-light  rounded-3xl mt-10 relative">
      ...
      <div className="w-full flex justify-between items-center rounded-xl mt-5 pb-5 md:hidden">
        <nav>
