...
export default function Card({ preço, link, title }) {
    ...
    <div className="group bg-black/5 flex flex-col w-56 h-56 p-5 rounded-xl relative felx justify-center items-center">
      ...
      >
        ...
        >
          ...
          <FontAwesomeIcon icon={faCartPlus} className={` h-10 ${isTapped1 ? "text-yellow-500" : "text-light"} transition ease-in-out duration-300`}
          />
          Comprar
          </div>
        </motion.div>
        ...
        >
          ...
          <FontAwesomeIcon icon={faHeart} className={` h-10 ${isTapped ? "text-red-500" : "text-light"} transition ease-in-out duration-300`}
          />
          Favoritar
          </div>
        </motion.div>
